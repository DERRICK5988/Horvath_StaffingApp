		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#horvathstaffingapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"horvathstaffingapp-display": {
								"semanticObject": "horvathstaffingapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=horvath.staffingapp",
									"url": sap.ui.require.toUrl("horvath/staffingapp")
								}
							}
						}
					}
